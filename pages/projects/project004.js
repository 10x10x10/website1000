...
export default function ProjectPage(props) {
  ...
  return (
    <Project id="project004">
      ...
      <TextContainer>
        <h1>Pony5ibe - They said ft.陳嫺靜 【Animated Music Video】</h1>
        <p>以分割畫面讓觀者在同一時間看見不同時空的故事，女主與男主在一條相同的「道路」行走，不過彼此的出發地、出發的起因、時空都不相同。而他們在道路中透過光的形式對話。</p>
        <p>在觀者的時間線視角來看，男主已經歷過一次整個道路，在這段道路他沒有得到任何覺醒，因此他做了一個決定，他回頭再次經歷一切。而女主是剛剛進入這段道路的人，從初始探索。兩者在對話的過程中有聆聽、有思辯、有反省，彼此的想法雖不同，卻也因為彼此在「道路」上的對話而產生變化。</p>
        <p>我負責的部分是製作 2D 的動態影像，這次創作計畫幾乎沒有任何的限制，我特別喜歡這種狀態 ──「在我做出來之前，我永遠不知道我最後會做出什麼」的感覺。對我來說，如果製作影像時不具有實驗性，那就太過乏味了。</p>
        <p>反覆地聽著歌曲，讓自己沉浸其中，直到腦海中浮現影像，最後憑著直覺創作，過程所帶來的興奮感與滿足感，也許是持續創作最重要的動力吧。</p>
      </TextContainer>
