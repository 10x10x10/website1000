...
export default function ProjectPage(props) {
  ...
  return (
    <Project id="project003">
      ...
      <TextContainer>
        <h1>2020 台北電影節 Taipei Film Festival | 片頭動畫</h1>
        <p>台北電影節是每年於台灣台北市舉辦的電影節，主要由兩大競賽單元「國際新導演競賽」與「臺北電影獎」以及觀摩單元所組成。</p>
        <p>今年台北電影節再度邀請知名設計師廖小子創作主視覺，由「純粹」此一概念出發，運用光線直來直往的傳達與接收，呈現創作者的直抒胸臆與觀眾觀影時的感官動員。</p>
        <p>片頭動畫由平面主視覺所延伸，透過 3D 動畫呈現更豐的光影效果與金屬質感，觀影體驗猶如穿梭在三種感官之中，時而交替，時而重疊，最終由如快門般的出口看到全貌，也許觀者在觀影的同時於腦海錄製全新的影像。</p>
      </TextContainer>
